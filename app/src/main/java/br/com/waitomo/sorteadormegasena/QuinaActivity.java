...
public class QuinaActivity extends AppCompatActivity {
    ...
    private TextView numeroUm,numeroDois,numeroTres,numeroQuatro,numeroCinco,todosNumeros;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSortear.setOnClickListener(new View.OnClickListener() {
            ...
            private String regastarTodosNumeros(Integer[] numeros){
                return "Resultado:   " + formatarNumeroMenorQueDez(numeros[0]) + " - " + formatarNumeroMenorQueDez(numeros[1]) + " - " + formatarNumeroMenorQueDez(numeros[2]) + " - " + formatarNumeroMenorQueDez(numeros[3]) + " - " + formatarNumeroMenorQueDez(numeros[4]);
            }
        });
